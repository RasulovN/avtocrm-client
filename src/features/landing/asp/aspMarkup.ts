...
<section data-screen-label="Hero" style="position:relative;padding:88px 24px 70px;overflow:hidden">
  ...
  <div style="position:relative;z-index:1;max-width:1240px;margin:0 auto;display:grid;grid-template-columns:1.05fr 1fr;gap:54px;align-items:center">
    ...
    <div data-reveal style="position:relative">
      ...
      <div class="hide-mob" style="position:absolute;z-index:3;top:-26px;right:-26px;background:var(--card);border:1px solid var(--line);border-radius:14px;box-shadow:var(--shadow);padding:12px 15px;animation:floatA 5s ease-in-out infinite"><div style="font-size:11px;color:var(--ink-3)">${t.dash.clients}</div><div style="font-family:'Manrope';font-weight:800;font-size:20px;color:var(--ink)">12 480</div><div style="font-size:11px;color:var(--green);font-weight:600">${t.dash.clientsGrow}</div></div>
      <div class="hide-mob" style="position:absolute;z-index:3;bottom:36px;left:-40px;background:var(--card);border:1px solid var(--line);border-radius:14px;box-shadow:var(--shadow);padding:12px 15px;animation:floatB 6s ease-in-out infinite"><div style="display:flex;align-items:center;gap:8px"><span style="width:30px;height:30px;border-radius:8px;background:var(--green-soft);display:flex;align-items:center;justify-content:center"><svg width="15" height="15" viewBox="0 0 24 24" fill="none"><path d="M20 6L9 17l-5-5" stroke="var(--green)" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg></span><div><div style="font-size:11px;color:var(--ink-3)">${t.dash.expensesCtl}</div><div style="font-family:'Manrope';font-weight:700;font-size:14px;color:var(--ink)">${t.dash.expensesVal}</div></div></div></div>
      <div class="hide-mob" style="position:absolute;z-index:1;bottom:-22px;right:30px;background:linear-gradient(135deg,var(--primary),#0ea5e9);color:#fff;border-radius:14px;box-shadow:var(--shadow);padding:12px 16px;animation:floatA 7s ease-in-out infinite"><div style="font-size:11px;opacity:.85">${t.dash.stockRt}</div><div style="font-family:'Manrope';font-weight:800;font-size:18px">${t.dash.stockAcc}</div></div>
    </div>
  </div>
</section>
